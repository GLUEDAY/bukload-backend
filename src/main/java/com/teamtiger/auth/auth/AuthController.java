...
import com.teamtiger.auth.auth.dto.*;
import com.teamtiger.auth.security.JwtUtil;
import com.teamtiger.auth.user.User;              // ✅ 우리가 만든 엔티티
...
import org.springframework.security.core.annotation.AuthenticationPrincipal;  // ✅ 인증 사용자 주입용
