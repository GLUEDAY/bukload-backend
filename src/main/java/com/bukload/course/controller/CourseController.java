...
public class CourseController {
    ...
    public ResponseEntity<?> searchPlaces(
            ...
            @RequestParam(required = false) String sigunNm,
            @RequestParam(required = false) Long courseId
    ) {
        return ResponseEntity.ok(placeService.searchPlaces(query, sigunNm, courseId));
    }
    ...
    public ResponseEntity<?> searchPlacesMap(
            @RequestParam String query,
            @RequestParam(required = false) String sigunNm,
            @RequestParam(required = false) Long courseId
    ) {
