package com.bukload.localpaychecker.api;

import com.bukload.localpaychecker.dto.MerchantInfo;
...
public class LocalpayApiService {
    ...
    public Mono<Boolean> isLocalpayUsable(String sigunNm, String name) {
        return searchMerchants(sigunNm, name, null)
                .map(list -> !list.isEmpty()); // 하나라도 있으면 true
    }
